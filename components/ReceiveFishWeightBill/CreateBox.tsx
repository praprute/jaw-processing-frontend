        ...
        <BoxFillter>
            ...
            <ContentFillter>
                <Row gutter={[16, 8]}>
                    ...
                    <Col md={24} sm={24} xs={24}>
                        <StyledFormItems label='รายละเอียดเพิ่มเติม' name='description'>
                            <Input placeholder='รายละเอียดเพิ่มเติม' size='large' style={{ color: 'black' }} />
                        </StyledFormItems>
                    </Col>
                    <Col md={24} sm={24} xs={24}>
...
export default CreateFishWeightBox
