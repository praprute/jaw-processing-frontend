...
const CustomerFishSauceBill: NextPageWithLayout = () => {
    ...
    return (
        <div>
            <StyledGlassBox>
                <WrapContent>
                    <Title>เพิ่มผู้จำหน่ายน้ำปลา</Title>
...
CustomerFishSauceBill.getLayout = function getLayout(page: ReactElement) {
    return (
        <AppLayout>
            <>{page}</>
        </AppLayout>
...
export default CustomerFishSauceBill
