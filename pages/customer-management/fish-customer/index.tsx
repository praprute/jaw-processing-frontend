...
const CustomerFishBill: NextPageWithLayout = () => {
    ...
    return (
        <div>
            <StyledGlassBox>
                <WrapContent>
                    <Title>เพิ่มผู้จำหน่ายปลา</Title>
            ...
            <StyledGlassBox>
                <WrapContent>
                    <Title>รานการผู้จำหน่ายปลา</Title>
...
CustomerFishBill.getLayout = function getLayout(page: ReactElement) {
    return (
        <AppLayout>
            <>{page}</>
        </AppLayout>
...
export default CustomerFishBill
