...
const CustomerSolidSaltBill: NextPageWithLayout = () => {
    ...
    return (
        <div>
            <StyledGlassBox>
                <WrapContent>
                    <Title>เพิ่มผู้จำหน่ายเกลือ</Title>
            ...
            <StyledGlassBox>
                <WrapContent>
                    <Title>รานการผู้จำหน่ายเกลือ</Title>
...
CustomerSolidSaltBill.getLayout = function getLayout(page: ReactElement) {
    return (
        <AppLayout>
            <>{page}</>
        </AppLayout>
...
export default CustomerSolidSaltBill
