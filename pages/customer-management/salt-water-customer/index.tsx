...
const CustomerSaltWaterBill: NextPageWithLayout = () => {
    ...
    return (
        <div>
            <StyledGlassBox>
                <WrapContent>
                    <Title>เพิ่มผู้จำหน่ายน้ำเกลือ</Title>
            ...
            <StyledGlassBox>
                <WrapContent>
                    <Title>รานการผู้จำหน่ายน้ำเกลือ</Title>
...
CustomerSaltWaterBill.getLayout = function getLayout(page: ReactElement) {
    return (
        <AppLayout>
            <>{page}</>
        </AppLayout>
...
export default CustomerSaltWaterBill
